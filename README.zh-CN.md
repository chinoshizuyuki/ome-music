...
![Ome Music 主界面截图占位图](docs/assets/screenshot-main.png)

![Ome Music 设置截图占位图](docs/assets/screenshot-settings.png)
...
- `Ome.Music.Setup.exe`：Windows 安装包
- `Ome.Music.exe`：便携版可执行文件
